...
|---|---|---|
| `progress.sh` | Companion being raised: icon, number, 10-cell progress bar, percent (a random held berry's sprite instead once enough is banked to feed, or 🍙 where a sprite can't be shown) — or, while eggs are on offer, the eggs and the budget against the hatch price | `● #172 ░░░░░░░░░░ 9%` / `● #172 ██░░░░░░░░ 🍙` / `🥚 ×3 · 1.2M / 5.0M` |
| `previous.sh` | Last species reached by any evolution, a mid-line step or a graduation alike: icon, number, name (silent until then) | `● #26 Raichu` |
